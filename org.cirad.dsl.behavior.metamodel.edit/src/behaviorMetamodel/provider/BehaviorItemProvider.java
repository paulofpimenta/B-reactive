...
/**
 * This is the item provider adapter for a {@link behaviorMetamodel.Behavior} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BehaviorItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Behavior_parameters_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Behavior_parameters_feature", "_UI_Behavior_type"),
				 MetamodelPackage.Literals.BEHAVIOR__PARAMETERS,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MetamodelPackage.Literals.BEHAVIOR__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MetamodelPackage.Literals.BEHAVIOR__PARAMETERS);
			childrenFeatures.add(MetamodelPackage.Literals.BEHAVIOR__LOCALVARIABLE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MetamodelPackage.Literals.BEHAVIOR__LOCALVARIABLE,
