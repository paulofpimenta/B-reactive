...
/**
 * This is the item provider adapter for a {@link behaviorMetamodel.Type} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TypeItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MetamodelPackage.Literals.TYPE__TYPE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		TypeEnum labelValue = ((Type)object).getType();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Type.class)) {
			case MetamodelPackage.TYPE__TYPE:
