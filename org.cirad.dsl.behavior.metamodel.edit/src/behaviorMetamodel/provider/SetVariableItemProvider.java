...
/**
 * This is the item provider adapter for a {@link behaviorMetamodel.SetVariable} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SetVariableItemProvider extends PrimitiveActivitiesItemProvider {
	/**
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MetamodelPackage.Literals.SET_VARIABLE__ASSIGNMENT);
		}
	...
	public String getText(Object object) {
		String label = ((SetVariable)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_SetVariable_type") :
			getString("_UI_SetVariable_type") + " " + label;
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MetamodelPackage.Literals.SET_VARIABLE__ASSIGNMENT,
