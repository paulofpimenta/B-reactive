...
/**
 * This is the item provider adapter for a {@link behaviorMetamodel.ConstantExpression} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConstantExpressionItemProvider extends ExpressionItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MetamodelPackage.Literals.CONSTANT_EXPRESSION__VALUE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		ConstantExpression constantExpression = (ConstantExpression)object;
		return getString("_UI_ConstantExpression_type") + " " + constantExpression.getValue();
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ConstantExpression.class)) {
			case MetamodelPackage.CONSTANT_EXPRESSION__VALUE:
