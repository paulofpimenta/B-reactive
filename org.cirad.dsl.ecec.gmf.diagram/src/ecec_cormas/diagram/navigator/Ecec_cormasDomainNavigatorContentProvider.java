 ...
 * @generated
 */
public class Ecec_cormasDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public Ecec_cormasDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof ecec_cormas.diagram.navigator.Ecec_cormasDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((ecec_cormas.diagram.navigator.Ecec_cormasDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new ecec_cormas.diagram.navigator.Ecec_cormasDomainNavigatorItem(
