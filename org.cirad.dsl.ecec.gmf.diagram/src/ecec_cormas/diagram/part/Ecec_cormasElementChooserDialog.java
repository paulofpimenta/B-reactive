 ...
 * @generated
 */
public class Ecec_cormasElementChooserDialog extends Dialog {
	 ...
	 * @generated
	 */
	public Ecec_cormasElementChooserDialog(Shell parentShell, View view) {
		super(parentShell);
	...
	protected Control createDialogArea(Composite parent) {
		...
		getShell()
				.setText(
						ecec_cormas.diagram.part.Messages.Ecec_cormasElementChooserDialog_SelectModelElementTitle);
	...
	private boolean isValidModelFile(IFile file) {
		...
		return "ecec_cormas".equals(fileExtension); //$NON-NLS-1$
	}
