 ...
 * @generated
 */
public class Ecec_cormasModelingAssistantProviderOfAttribute2EditPart extends
	...
	public List<IElementType> getRelTypesOnTarget(IAdaptable target) {
		...
		return doGetRelTypesOnTarget((ecec_cormas.diagram.edit.parts.Attribute2EditPart) targetEditPart);
	}
	...
	public List<IElementType> doGetRelTypesOnTarget(
			ecec_cormas.diagram.edit.parts.Attribute2EditPart target) {
	...
	public List<IElementType> getTypesForSource(IAdaptable target,
		...
		return doGetTypesForSource(
				(ecec_cormas.diagram.edit.parts.Attribute2EditPart) targetEditPart,
				relationshipType);
	}
