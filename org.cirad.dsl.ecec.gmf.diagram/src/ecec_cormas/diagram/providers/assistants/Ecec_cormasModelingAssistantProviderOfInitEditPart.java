 ...
 * @generated
 */
public class Ecec_cormasModelingAssistantProviderOfInitEditPart extends
	...
	public List<IElementType> getRelTypesOnTarget(IAdaptable target) {
		...
		return doGetRelTypesOnTarget((ecec_cormas.diagram.edit.parts.InitEditPart) targetEditPart);
	}
	...
	public List<IElementType> doGetRelTypesOnTarget(
			ecec_cormas.diagram.edit.parts.InitEditPart target) {
	...
	public List<IElementType> getTypesForSource(IAdaptable target,
		...
		return doGetTypesForSource(
				(ecec_cormas.diagram.edit.parts.InitEditPart) targetEditPart,
				relationshipType);
	}
