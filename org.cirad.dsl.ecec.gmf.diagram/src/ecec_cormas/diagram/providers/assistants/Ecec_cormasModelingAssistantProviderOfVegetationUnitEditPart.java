 ...
 * @generated
 */
public class Ecec_cormasModelingAssistantProviderOfVegetationUnitEditPart
		extends
	...
	public List<IElementType> getRelTypesOnSource(IAdaptable source) {
		...
		return doGetRelTypesOnSource((ecec_cormas.diagram.edit.parts.VegetationUnitEditPart) sourceEditPart);
	}
	...
	public List<IElementType> doGetRelTypesOnSource(
			ecec_cormas.diagram.edit.parts.VegetationUnitEditPart source) {
	...
	public List<IElementType> getRelTypesOnSourceAndTarget(IAdaptable source,
		...
		return doGetRelTypesOnSourceAndTarget(
				(ecec_cormas.diagram.edit.parts.VegetationUnitEditPart) sourceEditPart,
				targetEditPart);
	}
	...
	public List<IElementType> getRelTypesOnTarget(IAdaptable target) {
		IGraphicalEditPart targetEditPart = (IGraphicalEditPart) target
				.getAdapter(IGraphicalEditPart.class);
		return doGetRelTypesOnTarget((ecec_cormas.diagram.edit.parts.VegetationUnitEditPart) targetEditPart);
	}
	...
	public List<IElementType> doGetRelTypesOnTarget(
			ecec_cormas.diagram.edit.parts.VegetationUnitEditPart target) {
	...
	public List<IElementType> getTypesForSource(IAdaptable target,
		...
		return doGetTypesForSource(
				(ecec_cormas.diagram.edit.parts.VegetationUnitEditPart) targetEditPart,
				relationshipType);
	}
