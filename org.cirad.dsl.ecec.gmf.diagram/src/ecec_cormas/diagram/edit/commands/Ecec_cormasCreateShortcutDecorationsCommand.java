 ...
 * @generated
 */
public class Ecec_cormasCreateShortcutDecorationsCommand extends
	 ...
	 * @generated
	 */
	public Ecec_cormasCreateShortcutDecorationsCommand(
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		for (Iterator it = myDescriptors.iterator(); it.hasNext();) {
			...
			if (view != null && view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				...
				shortcutAnnotation
						.getDetails()
						.put("modelID", ecec_cormas.diagram.edit.parts.ModelEditPart.MODEL_ID); //$NON-NLS-1$
