 ...
 * @generated
 */
public class ModelParametersAuthorEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public ModelParametersAuthorEditPart(View view) {
		super(view);
	}
			...
			parser = ecec_cormas.diagram.providers.Ecec_cormasParserProvider
					.getParser(
							...
							ecec_cormas.diagram.part.Ecec_cormasVisualIDRegistry
									.getType(ecec_cormas.diagram.edit.parts.ModelParametersAuthorEditPart.VISUAL_ID));
		}
		return parser;
	}
