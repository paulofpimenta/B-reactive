...
public class ModelEditPart extends DiagramEditPart {
	 ...
	 * @generated
	 */
	public final static String MODEL_ID = "Ecec_cormas"; //$NON-NLS-1$
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new ecec_cormas.diagram.edit.policies.ModelItemSemanticEditPolicy());
		installEditPolicy(
				EditPolicyRoles.CANONICAL_ROLE,
				new ecec_cormas.diagram.edit.policies.ModelCanonicalEditPolicy());
		installEditPolicy(
						...
						if (command != null) {
							return command
									.chain(new ICommandProxy(
											new ecec_cormas.diagram.edit.commands.Ecec_cormasCreateShortcutDecorationsCommand(
													getEditingDomain(),
													(View) getModel(),
													viewDescriptors)));
						}
