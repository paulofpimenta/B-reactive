 ...
 * @generated
 */
public class ModelParametersModelNameEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public ModelParametersModelNameEditPart(View view) {
		super(view);
	}
			...
			parser = ecec_cormas.diagram.providers.Ecec_cormasParserProvider
					.getParser(
							...
							ecec_cormas.diagram.part.Ecec_cormasVisualIDRegistry
									.getType(ecec_cormas.diagram.edit.parts.ModelParametersModelNameEditPart.VISUAL_ID));
		}
		return parser;
	}
