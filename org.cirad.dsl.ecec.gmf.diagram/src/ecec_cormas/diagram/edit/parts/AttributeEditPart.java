...
public class AttributeEditPart extends AbstractBorderedShapeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new ecec_cormas.diagram.edit.policies.AttributeItemSemanticEditPolicy());
	...
	protected void addBorderItem(IFigure borderItemContainer,
		...
		if (borderItemEditPart instanceof ecec_cormas.diagram.edit.parts.AttributeValueNameEditPart) {
