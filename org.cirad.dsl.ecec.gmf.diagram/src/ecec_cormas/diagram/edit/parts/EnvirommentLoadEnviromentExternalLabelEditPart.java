 ...
 * @generated
 */
public class EnvirommentLoadEnviromentExternalLabelEditPart extends
	...
	static {
		registerSnapBackPosition(
				ecec_cormas.diagram.part.Ecec_cormasVisualIDRegistry
						.getType(ecec_cormas.diagram.edit.parts.EnvirommentLoadEnviromentExternalLabelEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public EnvirommentLoadEnviromentExternalLabelEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new ecec_cormas.diagram.edit.policies.Ecec_cormasTextSelectionEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ecec_cormas.diagram.providers.Ecec_cormasParserProvider
					.getParser(
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(this, null,
					ecec_cormas.diagram.edit.parts.Ecec_cormasEditPartFactory
	...
	protected IFigure createFigurePrim() {
		return new EnvirommentLoadEnviromentExternalLabelFigure();
	}

	/**
	 * @generated
	 */
	public class EnvirommentLoadEnviromentExternalLabelFigure extends
			WrappingLabel {

		/**
		 * @generated
		 */
		public EnvirommentLoadEnviromentExternalLabelFigure() {
			this.setText("Load Enviromment");
		}
