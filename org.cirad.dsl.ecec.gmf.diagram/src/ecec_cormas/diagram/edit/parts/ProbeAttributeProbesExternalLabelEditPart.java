 ...
 * @generated
 */
public class ProbeAttributeProbesExternalLabelEditPart extends LabelEditPart
	...
	static {
		registerSnapBackPosition(
				ecec_cormas.diagram.part.Ecec_cormasVisualIDRegistry
						.getType(ecec_cormas.diagram.edit.parts.ProbeAttributeProbesExternalLabelEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public ProbeAttributeProbesExternalLabelEditPart(View view) {
		super(view);
	}
	...
	protected IFigure createFigurePrim() {
		return new ProbeAttributeProbesExternalLabelFigure();
	}

	/**
	 * @generated
	 */
	public class ProbeAttributeProbesExternalLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public ProbeAttributeProbesExternalLabelFigure() {
			this.setText("aAttributeProbe");
		}
