...
public class Attribute2EditPart extends AbstractBorderedShapeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new ecec_cormas.diagram.edit.policies.Attribute2ItemSemanticEditPolicy());
	...
	protected void addBorderItem(IFigure borderItemContainer,
		...
		if (borderItemEditPart instanceof ecec_cormas.diagram.edit.parts.AttributeValueName2EditPart) {
	 ...
	 * @generated
	 */
	public class AttributeFigure extends SVGFigure {

		/**
		 * @generated
		 */
		public AttributeFigure() {
			this.setURI("platform:/plugin/org.cirad.dsl.ecec.gmf/icons/svg/attribute.svg");
