 ...
 * @generated
 */
public class ProbeClassProbesExternalLabelEditPart extends LabelEditPart
	...
	static {
		registerSnapBackPosition(
				ecec_cormas.diagram.part.Ecec_cormasVisualIDRegistry
						.getType(ecec_cormas.diagram.edit.parts.ProbeClassProbesExternalLabelEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public ProbeClassProbesExternalLabelEditPart(View view) {
		super(view);
	}
	...
	protected IFigure createFigurePrim() {
		return new ProbeClassProbesExternalLabelFigure();
	}

	/**
	 * @generated
	 */
	public class ProbeClassProbesExternalLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public ProbeClassProbesExternalLabelFigure() {
			this.setText("aClassProbe");
		}
