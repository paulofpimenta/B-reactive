 ...
 * @generated
 */
public class ProbeNameProbeNameEditPart extends LabelEditPart implements
	...
	static {
		registerSnapBackPosition(
				ecec_cormas.diagram.part.Ecec_cormasVisualIDRegistry
						.getType(ecec_cormas.diagram.edit.parts.ProbeNameProbeNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	 ...
	 * @generated
	 */
	public ProbeNameProbeNameEditPart(View view) {
		super(view);
	}
	...
	protected IFigure createFigurePrim() {
		return new ProbeLabelFigure();
	}

	/**
	 * @generated
	 */
	public class ProbeLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public ProbeLabelFigure() {
			this.setText("Probe");
		}
