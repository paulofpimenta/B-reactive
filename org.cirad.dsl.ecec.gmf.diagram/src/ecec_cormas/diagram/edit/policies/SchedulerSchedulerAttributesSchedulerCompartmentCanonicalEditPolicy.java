 ...
 * @generated
 */
public class SchedulerSchedulerAttributesSchedulerCompartmentCanonicalEditPolicy
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return ecec_cormas.Ecec_cormasPackage.eINSTANCE
				.getScheduler_AttributesScheduler();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<ecec_cormas.diagram.part.Ecec_cormasNodeDescriptor> childDescriptors = ecec_cormas.diagram.part.Ecec_cormasDiagramUpdater
				.getSchedulerSchedulerAttributesSchedulerCompartment_7010SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return ecec_cormas.diagram.edit.parts.Attribute2EditPart.VISUAL_ID == ecec_cormas.diagram.part.Ecec_cormasVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<ecec_cormas.diagram.part.Ecec_cormasNodeDescriptor> childDescriptors = ecec_cormas.diagram.part.Ecec_cormasDiagramUpdater
				.getSchedulerSchedulerAttributesSchedulerCompartment_7010SemanticChildren((View) getHost()
						.getModel());
