 ...
 * @generated
 */
public class VegetationUnitVegetationUnitProtocolsCompartmentCanonicalEditPolicy
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return ecec_cormas.Ecec_cormasPackage.eINSTANCE.getClass_Protocols();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<ecec_cormas.diagram.part.Ecec_cormasNodeDescriptor> childDescriptors = ecec_cormas.diagram.part.Ecec_cormasDiagramUpdater
				.getVegetationUnitVegetationUnitProtocolsCompartment_7001SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		int visualID = ecec_cormas.diagram.part.Ecec_cormasVisualIDRegistry
				.getVisualID(view);
		return visualID == ecec_cormas.diagram.edit.parts.Init2EditPart.VISUAL_ID
				|| visualID == ecec_cormas.diagram.edit.parts.Control2EditPart.VISUAL_ID
				|| visualID == ecec_cormas.diagram.edit.parts.CustomProtocol2EditPart.VISUAL_ID;
	}
	...
	protected void refreshSemantic() {
		...
		List<ecec_cormas.diagram.part.Ecec_cormasNodeDescriptor> childDescriptors = ecec_cormas.diagram.part.Ecec_cormasDiagramUpdater
				.getVegetationUnitVegetationUnitProtocolsCompartment_7001SemanticChildren((View) getHost()
						.getModel());
