 ...
 * @generated
 */
public class SchedulerItemSemanticEditPolicy extends
		ecec_cormas.diagram.edit.policies.Ecec_cormasBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public SchedulerItemSemanticEditPolicy() {
		super(
					...
					case ecec_cormas.diagram.edit.parts.Attribute2EditPart.VISUAL_ID:
						for (Iterator<?> it = cnode.getTargetEdges().iterator(); it
							...
							if (ecec_cormas.diagram.part.Ecec_cormasVisualIDRegistry
									.getVisualID(incomingLink) == ecec_cormas.diagram.edit.parts.ProbeAttributeProbesEditPart.VISUAL_ID) {
