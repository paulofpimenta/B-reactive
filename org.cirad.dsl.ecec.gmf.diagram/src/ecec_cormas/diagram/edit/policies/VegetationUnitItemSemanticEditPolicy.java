 ...
 * @generated
 */
public class VegetationUnitItemSemanticEditPolicy extends
		ecec_cormas.diagram.edit.policies.Ecec_cormasBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public VegetationUnitItemSemanticEditPolicy() {
		super(
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (ecec_cormas.diagram.part.Ecec_cormasVisualIDRegistry
					.getVisualID(incomingLink) == ecec_cormas.diagram.edit.parts.RelationEditPart.VISUAL_ID) {
			...
			if (ecec_cormas.diagram.part.Ecec_cormasVisualIDRegistry
					.getVisualID(incomingLink) == ecec_cormas.diagram.edit.parts.ProbeClassProbesEditPart.VISUAL_ID) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (ecec_cormas.diagram.part.Ecec_cormasVisualIDRegistry
					.getVisualID(outgoingLink) == ecec_cormas.diagram.edit.parts.RelationEditPart.VISUAL_ID) {
				DestroyElementRequest r = new DestroyElementRequest(
				...
				for (Iterator<?> cit = node.getChildren().iterator(); cit
					...
					case ecec_cormas.diagram.edit.parts.Init2EditPart.VISUAL_ID:
						for (Iterator<?> it = cnode.getTargetEdges().iterator(); it
							...
							Edge incomingLink = (Edge) it.next();
							if (ecec_cormas.diagram.part.Ecec_cormasVisualIDRegistry
									.getVisualID(incomingLink) == ecec_cormas.diagram.edit.parts.EnvirommentLoadEnviromentEditPart.VISUAL_ID) {
								DestroyReferenceRequest r = new DestroyReferenceRequest(
	...
	protected Command getStartCreateRelationshipCommand(
		...
		if (ecec_cormas.diagram.providers.Ecec_cormasElementTypes.Relation_4004 == req
				.getElementType()) {
			return getGEFWrapper(new ecec_cormas.diagram.edit.commands.RelationCreateCommand(
	...
	protected Command getReorientRelationshipCommand(
		...
		case ecec_cormas.diagram.edit.parts.RelationEditPart.VISUAL_ID:
			return getGEFWrapper(new ecec_cormas.diagram.edit.commands.RelationReorientCommand(
					req));
		}
