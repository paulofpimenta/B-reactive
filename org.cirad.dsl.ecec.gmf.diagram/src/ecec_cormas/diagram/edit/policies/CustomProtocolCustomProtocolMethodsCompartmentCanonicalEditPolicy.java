 ...
 * @generated
 */
public class CustomProtocolCustomProtocolMethodsCompartmentCanonicalEditPolicy
	...
	protected List getSemanticChildrenList() {
		...
		List<ecec_cormas.diagram.part.Ecec_cormasNodeDescriptor> childDescriptors = ecec_cormas.diagram.part.Ecec_cormasDiagramUpdater
				.getCustomProtocolCustomProtocolMethodsCompartment_7004SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<ecec_cormas.diagram.part.Ecec_cormasNodeDescriptor> childDescriptors = ecec_cormas.diagram.part.Ecec_cormasDiagramUpdater
				.getCustomProtocolCustomProtocolMethodsCompartment_7004SemanticChildren((View) getHost()
						.getModel());
