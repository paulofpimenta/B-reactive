 ...
 * @generated
 */
public class CustomProtocolCustomProtocolMethodsCompartment2CanonicalEditPolicy
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return ecec_cormas.Ecec_cormasPackage.eINSTANCE.getProtocol_Methods();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<ecec_cormas.diagram.part.Ecec_cormasNodeDescriptor> childDescriptors = ecec_cormas.diagram.part.Ecec_cormasDiagramUpdater
				.getCustomProtocolCustomProtocolMethodsCompartment_7008SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		int visualID = ecec_cormas.diagram.part.Ecec_cormasVisualIDRegistry
				.getVisualID(view);
		return visualID == ecec_cormas.diagram.edit.parts.LogisticGrowth2EditPart.VISUAL_ID
				|| visualID == ecec_cormas.diagram.edit.parts.Method2EditPart.VISUAL_ID;
	}
	...
	protected void refreshSemantic() {
		...
		List<ecec_cormas.diagram.part.Ecec_cormasNodeDescriptor> childDescriptors = ecec_cormas.diagram.part.Ecec_cormasDiagramUpdater
				.getCustomProtocolCustomProtocolMethodsCompartment_7008SemanticChildren((View) getHost()
						.getModel());
