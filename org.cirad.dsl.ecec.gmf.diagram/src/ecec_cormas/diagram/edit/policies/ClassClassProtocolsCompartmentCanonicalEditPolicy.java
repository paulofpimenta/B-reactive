 ...
 * @generated
 */
public class ClassClassProtocolsCompartmentCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<ecec_cormas.diagram.part.Ecec_cormasNodeDescriptor> childDescriptors = ecec_cormas.diagram.part.Ecec_cormasDiagramUpdater
				.getClassClassProtocolsCompartment_7009SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<ecec_cormas.diagram.part.Ecec_cormasNodeDescriptor> childDescriptors = ecec_cormas.diagram.part.Ecec_cormasDiagramUpdater
				.getClassClassProtocolsCompartment_7009SemanticChildren((View) getHost()
						.getModel());
