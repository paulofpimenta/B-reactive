...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Equality Number</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.cirad.dsl.ecec.xtext.ecec.EcecPackage#getEqualityNumber()
 * @model
 * @generated
 */
public enum EqualityNumber implements Enumerator
{
  /**
  ...
  /**
   * An array of all the '<em><b>Equality Number</b></em>' enumerators.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  private static final EqualityNumber[] VALUES_ARRAY =
    new EqualityNumber[]
    {
      BIGGERTHAN,
      LESSTHAN,
  ...
  /**
   * A public read-only list of all the '<em><b>Equality Number</b></em>' enumerators.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  public static final List<EqualityNumber> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

  /**
   * Returns the '<em><b>Equality Number</b></em>' literal with the specified literal value.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  public static EqualityNumber get(String literal)
  {
    for (int i = 0; i < VALUES_ARRAY.length; ++i)
    {
      EqualityNumber result = VALUES_ARRAY[i];
  ...
  /**
   * Returns the '<em><b>Equality Number</b></em>' literal with the specified name.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  public static EqualityNumber getByName(String name)
  {
    for (int i = 0; i < VALUES_ARRAY.length; ++i)
    {
      EqualityNumber result = VALUES_ARRAY[i];
  ...
  /**
   * Returns the '<em><b>Equality Number</b></em>' literal with the specified integer value.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  public static EqualityNumber get(int value)
  {
    switch (value)
    {
   ...
   * @generated
   */
  private EqualityNumber(int value, String name, String literal)
  {
    this.value = value;
    this.name = name;
