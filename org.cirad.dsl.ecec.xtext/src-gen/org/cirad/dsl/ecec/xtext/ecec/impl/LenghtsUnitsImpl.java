...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Lenghts Units</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.cirad.dsl.ecec.xtext.ecec.impl.LenghtsUnitsImpl#getKilometer <em>Kilometer</em>}</li>
 *   <li>{@link org.cirad.dsl.ecec.xtext.ecec.impl.LenghtsUnitsImpl#getMeter <em>Meter</em>}</li>
 *   <li>{@link org.cirad.dsl.ecec.xtext.ecec.impl.LenghtsUnitsImpl#getMiles <em>Miles</em>}</li>
 *   <li>{@link org.cirad.dsl.ecec.xtext.ecec.impl.LenghtsUnitsImpl#getHectare <em>Hectare</em>}</li>
 *   <li>{@link org.cirad.dsl.ecec.xtext.ecec.impl.LenghtsUnitsImpl#getSquarekilometer <em>Squarekilometer</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class LenghtsUnitsImpl extends MinimalEObjectImpl.Container implements LenghtsUnits
{
  /**
  ...
  {
    return EcecPackage.Literals.LENGHTS_UNITS;
  }
  ...
  public void setKilometer(String newKilometer)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EcecPackage.LENGHTS_UNITS__KILOMETER, oldKilometer, kilometer));
  }
  ...
  public void setMeter(String newMeter)
  {
    ...
    meter = newMeter;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EcecPackage.LENGHTS_UNITS__METER, oldMeter, meter));
  }
  ...
  public void setMiles(String newMiles)
  {
    ...
    miles = newMiles;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EcecPackage.LENGHTS_UNITS__MILES, oldMiles, miles));
  }
  ...
  public void setHectare(String newHectare)
  {
    ...
    hectare = newHectare;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EcecPackage.LENGHTS_UNITS__HECTARE, oldHectare, hectare));
  }
  ...
  public void setSquarekilometer(String newSquarekilometer)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EcecPackage.LENGHTS_UNITS__SQUAREKILOMETER, oldSquarekilometer, squarekilometer));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case EcecPackage.LENGHTS_UNITS__KILOMETER:
        return getKilometer();
      case EcecPackage.LENGHTS_UNITS__METER:
        return getMeter();
      case EcecPackage.LENGHTS_UNITS__MILES:
        return getMiles();
      case EcecPackage.LENGHTS_UNITS__HECTARE:
        return getHectare();
      case EcecPackage.LENGHTS_UNITS__SQUAREKILOMETER:
