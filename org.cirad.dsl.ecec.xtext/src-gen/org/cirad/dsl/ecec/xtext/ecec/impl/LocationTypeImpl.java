 ...
 * <ul>
 *   <li>{@link org.cirad.dsl.ecec.xtext.ecec.impl.LocationTypeImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LocationTypeImpl extends MinimalEObjectImpl.Container implements LocationType
{
  ...
  {
    return EcecPackage.Literals.LOCATION_TYPE;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EcecPackage.LOCATION_TYPE__NAME, oldName, name));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case EcecPackage.LOCATION_TYPE__NAME:
        return getName();
    }
