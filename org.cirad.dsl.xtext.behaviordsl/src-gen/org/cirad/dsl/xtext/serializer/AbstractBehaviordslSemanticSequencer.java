...
public abstract class AbstractBehaviordslSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	 ...
	 *
	 * Constraint:
	 *     attributeclass=[AttributeClass|ID]
	 */
	protected void sequence_DeclaredAttributes(ISerializationContext context, DeclaredAttributes semanticObject) {
		...
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getDeclaredAttributesAccess().getAttributeclassAttributeClassIDTerminalRuleCall_0_1(), semanticObject.getAttributeclass());
		feeder.finish();
	}
	 ...
	 *
	 * Constraint:
	 *     (behavior=[Behavior|ID] outcome_edge+=UnconditionedEdge)
	 */
	...
	protected void sequence_SelectConditionalLocationFunction(ISerializationContext context, NamedFunction semanticObject) {
		...
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getSelectConditionalLocationFunctionAccess().getNameSelectLocationKeyword_0(), semanticObject.getName());
		feeder.finish();
	}
